...
\begin{equation*}
	...
	\end{aligned}
\end{equation*}
In totale $D_n = 2n + o(n) + 6k \log_2(n) = 2n + 6n + o(n) = 8n + o(n)$ bit. Per confrontare questa grandezza con il minimum theoretical lower bound consideriamo due insiemi isomorfi alle parentesi ben bilanciate: le foreste ordinate e gli alberi binari.
